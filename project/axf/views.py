...
def main(request):
    ...
    return render(request,'axf/main.html',{"title":"首页","loopWheelList":loopWheelList,"navList":navList,"nav2List":nav2List,"shop1":shop1,"shop2":shop2,"shop3":shop3,"shop4":shop4,"mainList":mainList})
...
def market(request,pageid,cid,sortid):
    ...
    return render(request, 'axf/market.html',{"title":"闪送超市","leftList":leftList,"goodsList":goodsList,"titlelist":titlelist,"id":pageid,"fllist":fllist})
...
def cart(request):
    ...
    return render(request, 'axf/cart.html', {"title": "购物车","cartslist":cartslist,"trueFlag":trueFlag})
